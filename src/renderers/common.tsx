...
export const MODULE_META: Record<ContentType, ModuleMeta> = {
  ...
  identity_reveal: { label: '身份揭晓', icon: 'key', blocking: true },
  date_task: { label: '约会', icon: 'heart', blocking: true },
  finger_game: { label: '手指游戏', icon: 'card', blocking: true },
  truth_game: { label: '真心话', icon: 'card', blocking: true },
  ...
  final_choice: { label: '最终选择', icon: 'route', blocking: true },
